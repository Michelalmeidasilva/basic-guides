...
const SortScreen = () => (
  <div class="molde">
    ...
    <p>
      1 D.Utilizando a função sort imprima o array de colaboradores ordenado por
      idade de forma crescente.
    </p>

    <button onClick={Sort.exercise01}>Executar exercício 01</button>

    <p>
      2 D.Utilizando a função sort imprima o array de colaboradores ordenado por
      idade de forma decrescente..
    </p>
    ...
    <p>
      ...
      por cargo, sendo a ordem: estagiario (1º), front-end (2º), back-end (3º),
      designer (4º).
    </p>
    ...
    <p>
      1 E. Utilizando a função sort imprima o array de installments ordenado por
      valor de forma decrescente.
    </p>

    <button onClick={Sort.exercise05}>Executar exercício 1 </button>

    <p>
      2 E. Utilizando a função sort imprima o array de installments ordenado por
      valor de forma crescente, em caso de empate, o desempate deve ocorrer pelo
      número da parcela de forma decrescente.
    </p>
